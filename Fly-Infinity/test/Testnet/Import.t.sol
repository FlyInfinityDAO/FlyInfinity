...
contract ImportMechanismForkTest is Test {
    ...
    address[4] supportAddresses = [address(1002), address(1010), address(1020), address(1030)];
    ...
    address daiHolder = 0x6Ac97c57138BD707680A10A798bAf24aCe62Ae9D;
    ...
    function test_ForkTestnet_NewRegistration_AfterImport() public {
        ...
        dai.approve(address(sdn), 150e18);
        sdn.Agreement_Road_Map();
        sdn.BeCome_Owner(address(address(1080)));
        vm.stopPrank();
    ...
    // function test_ForkTestnet_oNewRegistration_BlockedDuringImport() public {
    //     address newUser = address(9999);
    //     vm.prank(daiHolder);
    //     dai.transfer(newUser, 150e18);
    ...
    // function test_ForkTestnet_ImportStatus_Query() public {
    //     assertFalse(sdn.Import_Status());
    // }

    function test_ForkTestnet_Migrate() public view {
        ...
        for (uint256 i = 0; i < usersOld.length - 3; i++) {
            ...
            MockContract.Node memory oldUser = sdnOld.Owner_Info_Global(usersOld[i]);
    ...
    // function test_ForkTestnet_CompareOwnerAllTeamValues() public view {
    ...
    // function test_ForkTestnet_CompareOwnerLeftRightSaveValues() public view {
    //     // Get all addresses from old contract
    //     uint64 totalOldUsers = sdn.All_Owner_Number();
    ...
    // function test_ForkTestnet_CompareOwnerAllPointValues() public view {
    //     // Get all addresses from old contract
    //     uint64 totalOldUsers = sdn.All_Owner_Number();
    ...
    // function test_ForkTestnet_CompareOwnerBigSideValues() public view {
    //     // Get all addresses from old contract
    //     uint64 totalOldUsers = sdn.All_Owner_Number();
    ...
    // function test_ForkTestnet_CompareOwnerDirectsValues() public view {
    //     // Get all addresses from old contract
    //     uint64 totalOldUsers = sdn.All_Owner_Number();
    ...
    // function test_ForkTestnet_CompareOwnerUpLineValues() public view {
    //     // Get all addresses from old contract
    //     uint64 totalOldUsers = sdn.All_Owner_Number();
